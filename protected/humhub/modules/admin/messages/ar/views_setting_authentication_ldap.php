 ...
 */
return [
    'A TLS/SSL is strongly favored in production environments to prevent passwords from be transmitted in clear text.' => 'ينصح بشدة باستخدام طبقة حماية SSL أو TLS في بيئة مواقع الويب للحد من تسريب كلمات المرور كنص صريح.',
    ...
    'Status: Error! (Message: {message})' => 'الحالة: خطأ! (رسالة: {message})',
    'Status: OK! ({userCount} Users)' => 'الحالة: تمام! (عدد المستخدمين {userCount})',
    'Status: Warning! (No users found using the ldap user filter!)' => 'الحالة: تحذير! (لم يتم العثور على مستخدمين عبر فلتر LDAP)',
    'The default base DN used for searching for accounts.' => '',
    'The default credentials password (used only with username above).' => 'بيانات اعتماد كلمة المرور الافتراضية (للمستخدم المعين أعلاه)',
